 ...
 *
 * Created on 2 august 2003, 01:28
 */
...
public class PEResourceDirectory {
  ...
  public interface Replacer {
    ByteBuffer replace(ByteBuffer source);
  }

  public boolean replaceResource(String catId, int resourceId, int langId, Replacer replacer) {
    ...
    if ((catEntry != null) && (catEntry.Directory != null)) {
      ...
      if ((identEntry != null) && (identEntry.Directory != null)) {
        ...
        if ((langEntry != null) && (langEntry.Data != null)) {
          DataEntry dataslot = langEntry.Data;
          dataslot.setData(replacer.replace(dataslot.Data));
          return true;
        }
      }
    }
