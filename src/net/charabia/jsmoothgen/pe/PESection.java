...
public class PESection implements Cloneable {
  ...
  long PointerToLinenumbers; // This is the file-based offset of the line number table. This field is only used for debug purposes, and is
  // usualy set to 0 (28)(DWORD)
  int NumberOfRelocations; // In EXE's this field is meaningless, and is set 0 (32)(WORD)
  int NumberOfLinenumbers; // The number of line numbers in the line number table for this section. This field is only used for debug
  // purposes, and is usualy set to 0 (34)(WORD)
  ...
  public void dump(PrintStream out) {
    ...
    out.println("  VirtualSize= " + VirtualSize
    ...
    out.println("  SizeOfRawData= " + SizeOfRawData
        + "   // 	The size of the section in the PE file. Must be a multiple of 512 (16)(DWORD)");
    out.println("  PointerToRawData= " + PointerToRawData
    ...
    out.println("  Characteristics= " + Characteristics
